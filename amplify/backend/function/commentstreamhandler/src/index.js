...
function processRecords(records) {
    ...
    for (let record of records) {
        ...
        if (newImage && (eventName === 'INSERT')) {
            const Item = {
                id: keys.id,
                commentAuthorId: newImage.commentAuthorId,
                commentEventId: newImage.commentEventId,
                commentToId: newImage.commentToId,
                commentAtId: newImage.commentAtId,
                commentScheduleId: newImage.commentScheduleId,
                oldImage,
                newImage,
