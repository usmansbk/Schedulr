...
export default {
  ...
  ALERT_whatIsAScheduleA: "Add your events to a specific list, and people who follow the list will be informed of your events.",
  ALERT_privateSchedule: "Private List",
  ALERT_privateScheduleA: "This list is only be visible to those with invite link.",
