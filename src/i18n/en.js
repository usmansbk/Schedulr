...
export default {
  ...
  ALERT_privateScheduleA: "Events created after setting schedule to 'Private' will only be visible to those with invite link.",
  ALERT_privateScheduleWarn: "Future events will only be visible to those with invite link.",
