...
export const searchPeople = `query SearchPeople($filter: SearchableUserFilterInput!, $limit: Int, $nextToken: Int) {
  searchUsers(filter: $filter, limit: $limit, nextToken: $nextToken) @connection(key: "searchPeople") {
    items {
      id
      name
      pictureUrl
